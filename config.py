...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.gpt_path = 'experiments/all_best_model_sd11_lr0.0001_bs2_ga16/minimum_loss_model_GAT_5_emb_n_strategy'
        # self.gpt_path = 'experiments/all_best_model_sd11_lr0.0001_bs2_ga16/best_model_GAT_5_emb_n_strategy'
        self.vocab_path_train = './CLB/clb-processed/vocab'
        self.vocab_path_eval = None
        self.data_path = './CLB/clb-processed/'
        self.data_file = 'data_for_damd.json'
        self.dev_list = 'CLB/valListFile.json'
        self.test_list = 'CLB/testListFile.json'
        # self.dbs = {
        #         'Camera' : 'ppd_db/camera_db_processed.json',
        #         'Phone' : 'ppd_db/phone_db_processed.json',
        #         'Tablet' : 'ppd_db/phone_db_processed.json',
        #         'Laptop' : 'ppd_db/laptop_db_processed.json',
        #         'Computer' : 'ppd_db/laptop_db_processed.json'
        # }

        self.glove_path = './CLB/glove.6B.50d.txt'
        self.domain_file_path = 'CLB/clb-processed/domain_files.json'
        # self.slot_value_set_path = 'ppd_db/value_set_processed.json'
        self.multi_acts_path = 'CLB/clb-processed/multi_act_mapping_train.json'
        ...
        # evaluation settings
        self.eval_load_path = 'experiments/all_best_model_sd11_lr0.0001_bs2_ga16/minimum_loss_model_GAT_5_emb_n_strategy'
    ...
    def _init_logging_handler(self, mode):
        ...
        if self.save_log and self.mode == 'train':
            ...
            #eval_log_path = os.path.join(self.eval_load_path)
